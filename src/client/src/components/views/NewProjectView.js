    ...
    return (
        ...
        <form onSubmit={onSubmit} className='form'>
          <div data-cy="newProjectView" style={mystyle}>
              ...
              <DateInput disablePast label="Start Date" day={1} id="start_date" value={data.start_date} name='start_date' onChange={onDateChange}/>	              <DateInput label="Start Date" day={1} id="start_date" value={data.start_date} name='start_date' onChange={onDateChange}/>
