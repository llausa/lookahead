    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/project/:id" component={ProjectView} data-cy="projectView" render={ props => <ProjectView {...props} projectId={projectId}/>}><ProjectView redirect={redirectFunc} /></Route>
