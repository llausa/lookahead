    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/project/:projectId/edit" component={ProjectSettingsView} data-cy="projectSettingsView" render={ props => <ProjectView {...props} projectId={projectId}/>}><ProjectSettingsView redirect={redirectFunc} /></Route>
